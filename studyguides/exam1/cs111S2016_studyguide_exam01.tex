\input{111pre}
\begin{document}
\MYTITLE{Exam 1 Study Guide \\ Delivered: Wednesday, March 9, 2016 \\ Exam 1: Friday, March 18, 2016, 11:00 am}

\section*{Introduction}

This course will have its first exam on Wednesday, March 16, 2016 from 11:00 to 11:50 am. The exam will be ``closed
...
\begin{itemize}
  ...
  \item The visibility modifiers (e.g., {\tt public}) that support encapsulation in the Java language
