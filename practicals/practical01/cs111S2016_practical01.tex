...
cs111S2016/} directory that you previously created.  First, make a new directory called {\tt cs111S2016-<your user
...
them with your neighbor, a teaching assistant, a departmental tutor, or the course instructor if you are confused.
    ...
    \begin{verbatim}
        cd cs111S2016
        mkdir cs111S2016-<your user name>
        cd cs111S2016-<your user name>
    \end{verbatim}
    \vspace*{-.2in}
...
you completed each of these steps inside of the parent directory called {\tt cs111S2016-<your user name>}; if you are
...
window, which we will call the ``source'' window, you should navigate to the {\tt cs111s2016-share} directory by
clicking on the correct folder icons.  Now, please find the {\tt Kinetic.java} file that is stored inside of the {\tt
  cs111s2016-share} repository in the ``source'' window. In the second window, which we will call the ``destination''
window, you should follow the same process to first navigate to the {\tt cs111S2016-<your user name>} directory,
...
``source'' browser to the ``destination'' browser, ensuring that the file is transferred from the {\tt cs111s2016-share}
repository to the {\tt practical01/} directory of the {\tt cs111S2016-<your user name>} repository.  Once the files are
