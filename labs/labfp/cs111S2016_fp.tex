...
\MYHEADERS{Final Project}{Due: Monday, May 2, 2016 by 12:00 noon}
...
cs111S2016\-<first-user-name>-<second-user-name>}'' where both ``{\tt <first-user-name>}'' and ``{\tt
...
\begin{enumerate}
  ...
  \item {\bf Project Assigned and Project Proposal:} Wednesday, April 6, 2016
  ...
  \item {\bf Status Update and Project Demonstration}: Wednesday, April 27, 2016
  ...
  \item {\bf Final Project Due Date}: Monday, May 2, 2016 by 12 noon
    ...
    classroom session ends on the due date, students must submit the assignment no later than 2 pm on the due date.
