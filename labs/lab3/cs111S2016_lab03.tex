...
\item Students who want to learn the basics of how to use the {\tt Scanner} class can refer to pages 90 and 91 of the
...
some suggestions for completing this challenge! While it is not mandatory for you to complete this challenge, you are
invited to consider the advanced concept of output formatting if you have already completed the required parts of this
assignment.
