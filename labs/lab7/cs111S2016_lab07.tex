...
\MYTITLE{Lab 7\\Assigned: March 2, 2016\\
Due: March 9, 2016 by 2:30pm}
...
%   % \item {\bf Work on the Alden Hall computers.} If you want to work on a
%   %   different machine, be sure to transfer your programs to the Alden machines
%   %   and re-run them before submitting.

%   \item {\bf Update your repository often!} You should add, commit, and push
%     your updated files each time you work on them.  I will not grade your
%     programs until the due date has passed.

%   \item {\bf Review the Honor Code policy.} You may discuss programs with
%     others, but programs that are nearly identical to others will be taken as
%     evidence of violating the Honor Code.
...
the course instructor or a teaching assistant if you are not able to create your directory properly, following the steps
...
carefully between the team who discusses the principles underlying a problem with others and the team who produces
